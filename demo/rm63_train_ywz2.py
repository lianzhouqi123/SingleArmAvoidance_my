...
torch.save(agent.actor.state_dict(), 'actor_result_3_3.pth')
torch.save(agent.critic_1.state_dict(), 'critic_1_result_3_3.pth')
torch.save(agent.critic_2.state_dict(), 'critic_2_result_3_3.pth')

with open('return_list_3_3.csv', 'w', newline='') as f:
    writer = csv.writer(f)
