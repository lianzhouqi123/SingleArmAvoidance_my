...
return_list = rl.train_tran(env, agent, agent_expert, num_episodes, replay_buffer, minimal_size, batch_size,
                            epsino_max, epsino_min, epsino_descend_ratio)

torch.save(agent.actor.state_dict(), 'actor_result_4_1_1_tran3_1_2_tran3_5_tran1_obs1.pth')
torch.save(agent.critic_1.state_dict(), 'critic_1_result_4_1_1_tran3_1_2_tran3_5_tran1_obs1.pth')
torch.save(agent.critic_2.state_dict(), 'critic_2_result_4_1_1_tran3_1_2_tran3_5_tran1_obs1.pth')

with open('return_list_4_1_1_tran3_1_2_tran3_5_tran1_obs1.csv', 'w', newline='') as f:
    writer = csv.writer(f)
