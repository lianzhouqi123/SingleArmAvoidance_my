...
actor_path_1 = "actor_result_3_3.pth"
critic_1_path_1 = "critic_1_result_3_3.pth"
critic_2_path_1 = "critic_2_result_3_3.pth"
...
torch.save(agent.actor.state_dict(), 'actor_result_3_1_randinit.pth')
torch.save(agent.critic_1.state_dict(), 'critic_1_result_3_1_randinit.pth')
torch.save(agent.critic_2.state_dict(), 'critic_2_result_3_1_randinit.pth')

with open('return_list_3_1_randinit.csv', 'w', newline='') as f:
    writer = csv.writer(f)
