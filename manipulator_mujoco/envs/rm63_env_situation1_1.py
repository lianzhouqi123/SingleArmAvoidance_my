...
class Rm63Env_s1_1(gym.Env):
    ...
    def __init__(
        ...
        # obstacle
        # self.obstacle_ori_pos = np.array([-0.3, 0.0, 0.3])
    ...
    def _get_reward(self, action):  # , o_a_distance):
        """
        奖励
        """
        # 与障碍物距离
    ...
    def step(self, action) -> tuple:
        ...
        reward, done, terminated = self._get_reward(action)
        info = self._get_info()
